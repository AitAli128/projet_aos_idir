...
CONSUL_HTTP_ADDR = env("CONSUL_HTTP_ADDR", default="")
AUTH_SERVICE_NAME = env("AUTH_SERVICE_NAME", default="auth-service")
API_SERVICE_NAME = env("API_SERVICE_NAME", default="catalog-api")
